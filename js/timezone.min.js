...
ele.innerHTML=ele.innerHTML+'<option value="'+0+'">'+'EDT - Eastern Daylight Time (North America)'+'</option>';
ele.innerHTML=ele.innerHTML+'<option value="'+6+'">'+'CEST - Central European Summer Time'+'</option>';
function show(ele){
...
function calculateNewDate(time_str, option) {
	...
	return time_h.toString().padStart(2, "0") + ":" + time_m.toString().padStart(2, "0");
}